...
class App {
  ...
  constructor() {
    ...
    // Attach event handlers for form submission
  ...
  _moveToPopup(e) {
    // lets find the closest workout element from the clicked target
  ...
  _loadDefaultMap() {
    console.log('Loading default map (Antipolo)');
  ...
  _loadMap(position) {
    ...
    // test loading map
    console.log(`Loading map at your location: ${latitude}, ${longitude}`);
    // IMPORTANT PART
    // create coords array for map
  ...
  _newWorkout(e) {
    ...
    if (type === 'running') {
      ...
      //create the running object with the map coordinates and form data
  ...
  _renderWorkout(workout) {
    ...
    <div class="workout__details">
      ...
      <span c lass="workout__value">${workout.distance}</span>
  ...
  _getLocalStorage() {
    ...
    // ewaroew propwe workout object with inheritance
